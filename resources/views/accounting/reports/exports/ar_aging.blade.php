...
<div class="re-shell re-shell--wide">
    ...
    <header class="re-header">
        <div>
            <div class="re-kicker">الذمم المدينة</div>
            <h1>{{ $report_title }}</h1>
    ...
    <section class="re-card">
        <div class="summary-grid">
            <div>
                <div class="summary-val" style="color:#1d4ed8">{{ $fmt($total_outstanding) }}</div>
                <div class="summary-lbl">إجمالي المستحقات</div>
            </div>
            <div>
            ...
            <div>
                <div class="summary-val">{{ $customer_count }}</div>
                <div class="summary-lbl">عدد العملاء</div>
            </div>
            <div>
    ...
    {{-- Aging Table --}}
    <section class="re-card">
        <h2>تفاصيل التقادم حسب العميل</h2>
